...
class HomePage(Actions):
    ...
    learn_more_about_benadryl = '//p/a[contains(text(),"LEARN MORE ABOUT BENADRYL")]'
    ...
    view_all_benadryl_product = "//p/a[@href='/products' and contains(text(), 'VIEW ALL BENADRYL')]"
    reject = "//button[@id='onetrust-reject-all-handler']"
